...
function App() {
  const editor = useBlockNote({
    ...
    { id: 'f5604433-2922-48ec-b9fa-f77d90a5a331', type: 'image', props: { src: "https://media.istockphoto.com/id/1470130937/photo/young-plants-growing-in-a-crack-on-a-concrete-footpath-conquering-adversity-concept.webp?b=1&s=170667a&w=0&k=20&c=IRaA17rmaWOJkmjU_KD29jZo4E6ZtG0niRpIXQN17fc=" }, content: Array(0), children: Array(0) }
    ]
